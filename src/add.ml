      ...
      |RpcComplexMatrixUnit (el2, u2) ->
         ...
         if dim1 = dim2 then
            try
               ...
               Gsl.Matrix_complex.add c_el1 el2;
      ...
      |RpcFloatMatrixUnit (el2, u2) ->
         ...
         if dim1 = dim2 then
            try
               ...
               let copy = Gsl.Matrix_complex.copy el1 in
               Gsl.Matrix_complex.scale copy conv;
               Gsl.Matrix_complex.add copy c_el2;
      ...
      |RpcComplexMatrixUnit (el2, u2) ->
         ...
         if dim1 = dim2 then
            try
               ...
               let copy = Gsl.Matrix_complex.copy el1 in
               Gsl.Matrix_complex.scale copy conv;
               Gsl.Matrix_complex.add copy el2;
               stack#push (RpcComplexMatrixUnit (copy, u2))
            with Units.Units_error s ->
               stack#push gen_el1;
               stack#push gen_el2;
